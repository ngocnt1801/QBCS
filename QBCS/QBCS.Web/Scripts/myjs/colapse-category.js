    ...
    categoryView = {
        init: function () {        
            ...
            this.modelCategoryItem.on('click', function () {
                ...
                this.className += ' active';
                categoryOctopus.selectCategory(this.attributes["data-category"].value, this.attributes["data-topic"].value, this.attributes["data-level"].value);
            });
        ...
        renderListQuestionSelected: function(){
            ...
            $.each(listQuestions, function(index, item){
                questionCotainer.append(
                    ...
                    +"<td>"+index+"</td>"
                    +"<td>"+item.code+"</td>"
                    +"<td><i class='fa fa-times-circle text-danger remove-selected' data-index='"+index+"'></i></td>"
                    +"</tr>")
            });

            $(".remove-selected").on('click', function(){
                $(this).parent().parent().remove();
                categoryOctopus.removeQuestionSelected(this.attributes["data-index"].value);
            });
    ...
    categoryOctopus = {
        ...
        addListSelectedQuestion: function(){
            ...
            $.each(listSelected, function(index, item){
                categoryOctopus.addSelectedQuestion(item.attributes["data-code"].value, item.attributes["data-id"].value);
            });
        ...
        updateCategory: function(){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    topicId: categoryModel.categorySelected.learningoutcomeId,
        ...
        selectCategory:function(categoryId, topicId, levelId){
            categoryModel.categorySelected.categoryId = categoryId;
            categoryModel.categorySelected.learningoutcomeId = topicId;
